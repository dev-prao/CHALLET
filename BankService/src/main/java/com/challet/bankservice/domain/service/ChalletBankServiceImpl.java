...
public class ChalletBankServiceImpl implements ChalletBankService {
    ...
    public void createDefaultCategoriesAndMappingsForAccount(ChalletBank challetBank) {
        ...
        categoryMappingData.put("DELIVERY",
            Arrays.asList("배달의민족", "요기요", "쿠팡이츠", "교촌치킨", "도미노피자", "족발보쌈", "BBQ"));
        categoryMappingData.put("TRANSPORT",
            Arrays.asList("택시", "버스", "티머니", "카카오택시", "카카오바이크", "씽씽이", "S-OIL", "현대오일뱅크"));
        categoryMappingData.put("COFFEE",
            Arrays.asList("스타벅스", "할리스", "파스쿠치", "투썸플레이스", "이디야", "커피", "카페", "메가커피", "투썸플레이스",
                "봄봄", "컴포즈커피"));
        categoryMappingData.put("SHOPPING",
            Arrays.asList("무신사", "지그재그", "올리브영", "KREAM", "네이버쇼핑", "쿠팡"));
    ...
    @Override
    public String getAccountName(String tokenHeader,
